...
export async function onRequestPost(context) {
    ...
    try {
        ...
        // Pre-load only what we need
        let itemsLookup = new Map(); // For fast item value lookups
        let allCharities = { results: [] };

        try {
            // Get a reasonable subset of charities that covers most common ones
            // This gets top charities by name (alphabetically) which gives good coverage
